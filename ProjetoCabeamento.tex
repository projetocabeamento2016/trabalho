...
As certificações de rede serão executadas após o final da implementação deste projeto no Bloco "K" da UTFPR/CP. Os horários para da execução das certificações será das 8Hs. às 9Hs. somente do Bloco "K". Ao finalizar as certificações de rede será gerado o seguinte relatório:
