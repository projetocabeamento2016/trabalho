...
\begin{document}
	...
	\begin{itemize}
		...
		\item Cabos para Access Point Furukawa Cat6;
		\item UPS. 
	\end{itemize}
	Infraestrutura lógica rede do bloco "K" UTFPR/CP:
	\begin{itemize}
		...
		\item Corredor: 2 pontos para câmera e 2 pontos para wi-fi.
	\end{itemize}
	...
	\end{itemize}
	\textbf{Em média total de 76 Usuários que irão utilizar a rede do Bloco K da UTFPR/CP.}
	...
	\end{itemize}
	Após finalizado a passagem dos novos cabos e climpagem de seus conectores. A certificação de rede será realizada em toda rede. Desde sua origem (Patch Panel) até o destino (novos pontos de rede) contemplados no projeto no Bloco "K" da UTFPR/CP. 
	...
	Segue plano de horários para a certificação, sendo que deve ser executado em dois dias:
	\input{tab_horario}
	\\
